        ...
        <div className="Register">
            <div id="container">
                <form className="form" onSubmit={handleSubmit(save)}>
                    <div id="loginLabel">Register</div>
                    <div className="fullName">
                        <input className="form-content" type="text" placeholder="First Name" {...register("firstName", UserModel.firstNameValidation)} />
                        {formState.errors.firstName && <span className="tooltipText firstNamePosition">{formState.errors.firstName?.message}</span>}
                        <input className="form-content" type="text" placeholder="Last Name" {...register("lastName", UserModel.lastNameValidation)} />
                        {formState.errors.lastName && <span className="tooltipText">{formState.errors.lastName?.message}</span>}
                    </div>
                    <input className="form-content" type="text" placeholder="Email" {...register("email", UserModel.emailValidation)} />
                    {formState.errors.email && <span className="tooltipText emailPosition">{formState.errors.email?.message}</span>}
                    <input className="form-content" type="password" placeholder="Password" {...register("password", UserModel.passwordValidation)} />
                    {formState.errors.password && <span className="tooltipText passwordPosition">{formState.errors.password?.message}</span>}

                    <button className="registerBtn pointer">Register</button>
                    <p className="signIn">Already have an account? <NavLink to="/login">Login</NavLink> </p>
                </form>
